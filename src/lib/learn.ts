...
export const LEARN_PATHS = [
  {
    ...
    intro: [
      ...
      'Coffee Basics is a structured path for anyone who wants a better cup without turning the kitchen into a laboratory. You will learn what equipment matters, how to build a reliable recipe, how grind size and water affect flavour, and how familiar drinks compare.',
    ],
    outcomes: [
      ...
      'compare espresso, filter and milk drinks by method rather than name alone.',
    ],
    closing:
  ...
  },
  {
    ...
    intro: [
      ...
      'Dial In Espresso is a structured path for home baristas who want balanced shots, reliable milk texture and a workflow they can repeat the next morning. You will learn what dose, yield and time mean, how ratio and grind change a shot, how to recognise uneven extraction and how to keep the machine clean enough to taste the coffee rather than yesterday\u2019s coffee oils.',
    ],
    outcomes: [
      ...
      'calculate target yield for 1:1.5 to 1:3 espresso ratios.',
    ],
    closing:
